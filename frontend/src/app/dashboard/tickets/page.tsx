...
export default function TicketsPage() {
  ...
  useEffect(() => {
    ...
    if (categoryFilter !== "all") {
      filtered = filtered.filter(
        (ticket) => getTicketCategory(ticket) === categoryFilter
      );
    }
  ...
  // Use the actual category from the ticket instead of inferring it
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="service_fb">Service (F&B)</SelectItem>
              ...
              <>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    >
                      {getCategoryLabel(getTicketCategory(selectedTicket))}
                    </Badge>
                    <Badge
